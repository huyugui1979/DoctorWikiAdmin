...
angular.module('myApp.doctor', ['NewfileDialog', 'angularModalService','ngFileUpload', 'cgBusy', 'ngRoute', 'ui.grid', 'ui.grid.edit', 'ui.grid.cellNav', 'ui.grid.treeView', 'ui.grid.selection', 'ui.grid.pagination'])
    ...
    .controller('CategoryCtrl', function ($scope, close,$http, entity) {
        ...
        var loadCategory = function () {
            $http.get('http://113.31.89.204:3000/category').success(function (result) {
                var data = [];
                var count=0;
    ...
    .controller('DoctorCtrl', function ($scope,Upload,ModalService, $http, fileDialog) {
        ...
        var loadCategory = function () {
            $scope.myPromise = $http.get('http://113.31.89.204:3000/category').success(function (result) {
                //
        ...
        var updateDoctor = function(entity){
            //
            $scope.myPromise = $http.put('http://113.31.89.204:3000/doctors', entity).success(function (data) {
                //
        ...
        var addDoctor=function(entity){
            $scope.myPromise = $http.post('http://113.31.89.204:3000/doctors', entity).success(function (data) {
                getTatalPage();
                getPage();
            }).error(function (data) {
        ...
        $scope.delDoctor = function(entity){
            //
            //
            $scope.myPromise = $http.delete('http://113.31.89.204:3000/doctors',{params:entity}).success(function (data) {
                //
                getTatalPage();
                getPage();
                //
        ...
        $scope.changePortait = function(object){
            ...
            fileDialog.openFile(function (e) {
                ...
                $scope.myPromise=Upload.upload({
                    url: 'http://113.31.89.204:3000/portrait',
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                {
                    name: '头像',
                    cellTemplate: '<a  ng-if="row.entity.$$treeLevel != 0" class="btn" ng-click="$event.stopPropagation();grid.appScope.changePortait(row.entity)"><img width="30" height="30" ng-src="http://113.31.89.204:3000/images/{{row.entity.image}}" ></a>'
                },
                {
                    name: '兴趣',
        ...
        var getTatalPage = function () {
            $scope.myPromise = $http.get('http://113.31.89.204:3000/doctors/count').success(function (data) {
        ...
        var getPage = function () {
            //var url = "http://"
            $scope.myPromise = $http.get('http://113.31.89.204:3000/doctors', {
                params: {
